...
export const InvoiceSummary = ({ loadRate, carrierCost }: InvoiceSummaryProps) => {
  ...
  return (
    <div className="invoice-container border border-gray-200 rounded-lg p-6 bg-white">
      {/* Standard Service Fee */}
      <div className="row flex justify-between py-3 border-b border-gray-100">
      ...
      <div className="row total flex justify-between py-4 mt-2 bg-gray-50 px-4 rounded">
